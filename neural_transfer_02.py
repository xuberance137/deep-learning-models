...
def parse_and_set_arguments():
    ...
    global base_image_path, style_reference_image_path, result_prefix, iterations
    global total_variation_weight, style_weight, content_weight
    global width, height, img_nrows, img_ncols
...
if __name__ == '__main__':
    ...
    # returns the value of layer 'outputs', ie. loss with learning given input combination_image
    # this value is used in Evaluator in eval_loss_and_grads
